  ...
  return (
    <div className="min-h-screen bg-black text-white pb-16 pt-40 px-4" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      <div className="container mx-auto max-w-4xl">
        ...
        <div
          className={`bg-[#12121e] rounded-xl shadow-lg border border-gray-800 overflow-hidden ${visibleSections.form ? "fade-in" : "fade-in-slow"}`}
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-black/30 p-6 rounded-xl border border-gray-700 transition-all duration-300 hover:shadow-purple-500/10 hover:shadow-lg">
                  ...
                  <select
                    ...
                    style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 300, letterSpacing: "0.3px" }}
                  >
                    <option value="" className="bg-[#0a0a13] text-gray-300">
                      Select an option
                    </option>
                    <option value="Instagram" className="bg-[#0a0a13] text-gray-300">
                      Instagram
                    </option>
                    <option value="WhatsApp" className="bg-[#0a0a13] text-gray-300">
                      WhatsApp
                    </option>
                    <option value="Friends/Family" className="bg-[#0a0a13] text-gray-300">
                      Friends/Family
                    </option>
                    <option value="Posters" className="bg-[#0a0a13] text-gray-300">
                      Posters
                    </option>
                    <option value="Other" className="bg-[#0a0a13] text-gray-300">
                      Other
                    </option>
                  </select>
                </div>
