...
const HomePage = () => {
  ...
  return (
    <div className="bg-black min-h-screen" style={{ fontFamily: "'DM Serif Display', serif" }}>
      {/* Hero Section */}
      <Hero />
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {experiences.map((experience, index) => (
                  <div
                    key={experience._id}
                    className={`stagger-fade-in fade-in-slow ${visibleSections.experiences ? "active" : ""}`}
      ...
      <div className="bg-black py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div
            id="features"
            className={`grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 ${visibleSections.features ? "fade-in" : "fade-in-slow"}`}
          >
