  ...
  return (
    <div className="bg-black">
      ...
      <div className="bg-black py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div id="experiences" className="mb-12">
            <h2 className="text-3xl font-bold text-white mb-6">Upcoming Experiences</h2>
            ...
            {loading ? (
              ...
              <div className="bg-white border border-gray-200 text-black px-4 py-3 rounded">
                {error}
              </div>
            ) : experiences.length === 0 ? (
              <div className="bg-white border border-gray-200 text-black px-4 py-10 rounded text-center">
                <p className="text-xl">No upcoming experiences at the moment.</p>
                <p className="mt-2">Check back soon!</p>
              </div>
            ) : (
      ...
      <div className="bg-black py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div id="about" className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">About Unplugged</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            <div className="bg-white p-6 rounded-lg text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
              ...
              <h3 className="text-xl font-semibold text-black mb-2">Local Experiences</h3>
            ...
            <div className="bg-white p-6 rounded-lg text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
              ...
              <h3 className="text-xl font-semibold text-black mb-2">Curated Events</h3>
              <p className="text-black">
                Join workshops, classes, and events that inspire creativity and foster community connections.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg text-center transform transition-all duration-300 hover:-translate-y-2 hover:shadow-lg">
              ...
              <h3 className="text-xl font-semibold text-black mb-2">Intimate Settings</h3>
              <p className="text-black">
                Enjoy small-group experiences that allow for personal interaction and hands-on learning.
              </p>
            </div>
      ...
      <div className="bg-black py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div id="host" className="bg-white rounded-lg p-8 text-center shadow-lg transition-all duration-300 hover:shadow-xl">
            <h3 className="text-2xl font-bold text-black mb-4">Want to host an experience?</h3>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center bg-teal-600 hover:bg-teal-700 text-white font-semibold py-2 px-6 rounded-md transition-all duration-300 transform hover:scale-105"
            >
              <MessageSquare className="mr-2 h-5 w-5" />
              Get in Touch
            </a>
