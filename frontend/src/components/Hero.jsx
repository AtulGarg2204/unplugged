...
const Hero = () => {
  ...
  return (
    <div className="relative h-[600px] overflow-hidden">
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-20 px-4">
            ...
            <button
              onClick={handleExploreClick}
              className="bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 px-8 rounded-md transition-all duration-300 text-lg transform hover:scale-105 hover:shadow-lg"
            >
              Explore Experiences
            </button>
          </div>
      ...
      <button
        onClick={goToPrevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 z-30 bg-black/40 hover:bg-teal-600/80 text-white p-2 rounded-full transition-all duration-300 transform hover:scale-110"
        aria-label="Previous slide"
      >
        <ChevronLeft size={24} />
      </button>
      <button
        onClick={goToNextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-30 bg-black/40 hover:bg-teal-600/80 text-white p-2 rounded-full transition-all duration-300 transform hover:scale-110"
        aria-label="Next slide"
      >
        <ChevronRight size={24} />
      </button>
